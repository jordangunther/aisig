			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						...
						<!-- Work -->
							<article id="work">
								<h2 class="major">IASIG Courses</h2>
						...
						<!-- About -->
                            ...
                            <div class="bg-white image_text">
                                ...
                                <form id="commentForm" method="GET" action="/contact/sent" class="validate" enctype="multipart/form-data">
                                    {{ csrf_field() }}
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
				...
				<!-- Footer -->
					<footer id="footer">
						<p class="copyright">&copy; 2018 <a href="https://www.iasig.org/" target="_blank">IASIG</a></p>
					</footer>
