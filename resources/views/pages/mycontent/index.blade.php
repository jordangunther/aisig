...
<div class="outer">
    <div class="inner bg-container">
        <div class="row">
                <div class="col-lg-12">
                    @include('components.table.courses.tablemy')
                </div>
            </div>
            <div class="row m-t-35">
                <div class="col-lg-12">
                    @include('components.table.files.tablemyIn')
                </div>
            </div>
            <div class="row m-t-35">
                <div class="col-lg-12">
            ...
            @foreach ($course as $courses)
                @include('components.modal.courses.delete')
                @include('components.modal.courses.myupdate')
            @endforeach

            @include('components.modal.courses.create')

            @foreach ($lesson as $lessons)
                @include('components.modal.lessons.delete')
                @include('components.modal.lessons.myupdate')
                @include('components.modal.lessons.download')
            @endforeach

            @include('components.modal.lessons.create')
            @include('components.modal.files.create')
