            ...
            <div class="col-lg-6 col-sm-7">
                <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                    <li class="breadcrumb-item">
                        <a href="/authors">
                            <i class="fa fa-home" aria-hidden="true"></i> Authors
                        </a>
                    </li>
                    <li class="breadcrumb-item active">{{ $author[0]->first_name }} {{ $author[0]->last_name }}</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="outer">
    <div class="inner bg-container">
        <div class="row">
            ...
            <div class="col-10 m-t-35">
                <div>
                    <h1>{{ $author[0]->first_name }} {{ $author[0]->last_name }}</h1>
                    <hr>
