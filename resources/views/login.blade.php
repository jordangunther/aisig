                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    <input type="email" class="form-control b_r_20" id="email" name="email" placeholder="E-mail" value="{{ old('email') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control b_r_20" id="password" name="password" placeholder="Password" required>
                                    <span class="input-group-text bl-0">
                            ...
                            <div class="row m-t-15">
                                <div class="col-lg-12">
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }} class="custom-control-input form-control">
                                        <span class="custom-control-label text-white">Keep me logged in</span>
                                    </label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6 m-t-10">
                                    <a href="register" class="forgottxt_clr text-white"><i class="fa fa-external-link"></i> Register Now</a>
                                </div>
