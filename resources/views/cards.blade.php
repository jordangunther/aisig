                            ...
                            <div class="row">
                                <div class="col-lg">
                                    <div class="card bd-card card-fade-in m-t-35">
                                        <img class="card-img-top img-fluid b_r_5 card_img_height" src="{{asset('assets/img/wallpaper6.jpg.jpg')}}" alt="Card image cap">
                                        ...
                                        <div class="card-body">
                                            <article data-spy="scroll" data-target="#scrollspy-nav" data-offset="0" class="scrollspy-example">
                                                ...
                                                <div class="card card-inverse text-center m-t-20 m-r-15" id="card3">
                                                    <img class="card-img-top img-fluid card_img_height" src="{{asset('assets/img/wallpaper6.jpg.jpg')}}" alt="Photo of sunset">
