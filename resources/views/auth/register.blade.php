                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control " name="first_name" id="firstName" placeholder="First Name" value="{{ old('first_name') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control " name="last_name" id="lastName" placeholder="Last Name" value="{{ old('last_name') }}" required autofocus>
                                    <span class="input-group-text bl-0">
                                        <i class="fa fa-user text-white"></i>
                                    </span>
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    <input type="email" placeholder="Email Address" name="email" id="email" class="form-control " value="{{ old('email') }}" required>
                                    <span class="input-group-text  bl-0">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="password" placeholder="Confirm Password" name="password_confirmation" id="password-confirm" class="form-control " required>
                                    <span class="input-group-text bl-0">
                                        <i class="fa fa-key text-white"></i>
                                    </span>
                                </div>
                            </div>
                            <input type="hidden" name="background_image" class="custom-control-input form-control" value="banner_carbon.jpg">
                            <!-- <div class="form-group row">
                                <div class="col-12">
                                    <label class="col-form-label text-white">Select Background Color</label>
                                </div>
                                <div class="col-12">
                                    <label class="custom-control custom-radio">
                                        <input type="radio" name="background_image" class="custom-control-input form-control" value="banner_sky.jpg" checked>
                                        <span class="custom-control-label"></span>
                                        <a class="custom-control-description">Blue</a>
                                    </label>
                                    <label class="custom-control custom-radio">
                                        <input type="radio" name="background_image" class="custom-control-input form-control" value="banner_neutral.jpg">
                                        <span class="custom-control-label"></span>
                                        <a class="custom-control-description">White</a>
                                    </label>
                                    <label class="custom-control custom-radio">
                                        <input type="radio" name="background_image" class="custom-control-input form-control" value="banner_watermelon.jpg">
                                        <span class="custom-control-label"></span>
                                        <a class="custom-control-description">Red</a>
                                    </label>
                                    <label class="custom-control custom-radio">
                                        <input type="radio" name="background_image" class="custom-control-input form-control" value="banner_carbon.jpg">
                                        <span class="custom-control-label"></span>
                                        <a class="custom-control-description">Grey</a>
                                    </label>
                                </div>
                            </div> -->
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    ...
                                    <label class="custom-control custom-radio">
                                        ...
                                        <span class="custom-control-label"></span>
                                        <a class="custom-control-description">To View and Upload Own Courses</a>
                                    </label>
                                    <label class="custom-control custom-radio">
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                <label for="description" class="col-form-label text-white control-label">Description About You *</label>

                                    <textarea placeholder="Must be at least 100 characters..." name="description" id="description" class="form-control " value="{{ old('description') }}" required minlength="100"></textarea>
                                    <span class="input-group-text bl-0">
