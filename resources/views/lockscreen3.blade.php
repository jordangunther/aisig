            ...
            <div class="row">
                <div class="col-xl-4  col-lg-6 mx-auto lock3_border lock_section_top3">
                    <div class="text-center collapse lock_show">
                        <img src="{{asset('assets/img/profile.jpg')}}" alt="admin" class="rounded-circle admin_img_top3">
                    </div>
                    ...
                    <div class="text-center unlock admin_bottom">
                        <img src="{{asset('assets/img/profile.jpg')}}" alt="admin" class="rounded-circle lock_admin lock_admin3">
                    </div>
