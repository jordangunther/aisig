    ...
    <div id="top">
        ...
        <nav class="navbar navbar-static-top">
            <div class="container-fluid">
                <a class="navbar-brand te\xt-xs-center" href="index.html">
                    <h3><img src="img/favicon.ico" class="admin_img" alt="logo"> ADMIRE ADMIN</h3>
                </a>
                <div class="menu">
                    ...
                    <div class="btn-group">
                        <div class="user-settings no-bg">
                            <button type="button" class="btn btn-default no-bg micheal_btn" data-toggle="dropdown">
                                <img src="img/profile.jpg" class="admin_img2 img-thumbnail rounded-circle avatar-img"
                ...
                <ul id="menu">
                    ...
                    <li>
                        <a href="calendar.html">
                            ...
                            <span class="badge badge-pill badge-primary float-right calendar_tag menu_hide">7</span>
                        </a>
                    </li>
                    <li>
                        <a href="gallery.html">
                ...
                <div class="inner bg-container">
                    <div class="card">
                        ...
                        <div class="card-block card_block_top_align ">
                            ...
                            <p> Admire Admin Theme is build with Bootstrap v4.0.0-alpha.3 And it is a fully responsive
                                theme...</p>
                            <p class="text-justify">Lorem ipsum dolor sit amet, facer honestatis ut usu, eripuit docendi
                                volumus eu mel, sea ad case
                                nusquam voluptua. An mei vidit saepe adolescens, qui in diam nostro. Regione dolores his
                                no,
                                mea audiam vidisse dolorem et. Qui wisi nulla electram ut, his soleat virtute temporibus
                                an,
                                primis hendrerit eu ius.
                                Vix ea audire rationibus. Tale aperiri sit ad, zril noluisse ut sit.
                                Altera euismod propriae eam ex, has aeque lobortis reprimique ad, mei cu oratio
                                salutandi
                            ...
                            <div class="html_code">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <h1>hgfdjghjdfhgjfdhg</h1>
                                        <span>mahesh reddy</span>
                                        <p>
                                        Be sure to add aria-expanded to the control element. This attribute explicitly defines the current state
                                        of the collapsible element to screen readers and similar assistive technologies.</p>
                    ...
                    <div id="settings_section">
                        <div class="layout_styles">
                            ...
                            <form autocomplete="off">
                                ...
                                <div class="col-12">
                                    <div class="float-left m-t-20">Folded Menu</div>
                                    <div class="float-right m-t-15">
...
<script>
    ...
    if (bsElement.length) {
        ...
        $("<link/>", {
            rel: "stylesheet",
            type: "text/css",
            href: "https://cdn.jsdelivr.net/highlight.js/9.9.0/styles/atelier-lakeside-light.min.css"
        }).appendTo("head");

        $.getScript("https://cdn.jsdelivr.net/highlight.js/9.9.0/highlight.min.js");

        var modalSource = '<div class="modal fade" id="html-modal" tabindex="-1" role="dialog">  ' +
                ...
                '<div class="highlight" id="copyTarget"> ' +
                '<pre> ' +
                '<code class="language-html" data-lang="html"></code> ' +
                '</pre> ' +
                '</div> </div> ' +
                '<div class="modal-footer"> ' +
                '<button type="button" class="btn btn-warning" id="copyButton">Copy code</button><button type="button" class="btn btn-primary btn-clipboard">Highlight Source</button> ' +
                '</div> </div> </div> </div>';
...
// Code btn definition
        var codeBtn = $("<div id='html_button' class='btn btn-primary btn-xs'>&lt; &gt;</div>")
        codeBtn.click(function() {
            var html = $(this).parent().html();
            html = cleanSource(html);
            $("#html-modal pre").text(html);
            $("#html-modal").modal();

// Init Highlight.js plugin after delay
            var source = $("#html-modal").find('pre');
            setTimeout(function() {
