...
z-index: 999999">
        <img src="{{asset('assets/img/IASIG_logo.png')}}" style=" width: 40px;" alt="loading...">
    </div>
</div>
<div id="animate">
    ...
    <div class="text-center">
        <img src="{{asset('assets/img/IASIG_logo.png')}}" class="img-fluid center-block" alt="Page Not Found" />
    </div>
    <div class="text-white number text-center">
        Go back to
