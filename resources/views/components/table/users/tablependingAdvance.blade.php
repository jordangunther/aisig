<div class="card">
    <div class="card-header bg-white">
        <h3>Manage Pending Contributors</h3>
    </div>
    <div class="card-body">
                    ...
                    @foreach ($user as $users)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/users/approveAdvance/{{ $users->id }}"><button class="buttonSpacing widget_btn btn btn-sm btn-outline-success"><i class="fa fa-check" aria-hidden="true"></i> APPROVE</button></a>
