    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title text-white" id="modalLabelsuccess">Update Lesson</h4>
                    ...
                    <form id="commentForm" method="post" action="/lessons/updates/{{ $lessons->id }}" class="validate" enctype="multipart/form-data">
                        ...
                        <div class="tab-content">
                            <div class="form-group">
                                <label for="lessonTitle" class="control-label">Lesson
                                    Title</label>
                            ...
                            <div class="form-group">
                                <label for="user_id" class="control-label">Lesson
                                    User</label>
                            ...
                            <div class="form-group">
                                <label for="course_id" class="control-label">Lesson
                                    Course</label>
                            ...
                            <div class="form-group">
                                <label for="description" class="control-label">Lesson
                                    Description</label>
                            ...
                            <div class="form-group">
                                <label for="status" class="control-label">Lesson
                                    Status</label>
                            ...
                            <button type="submit" class="buttonSpacing widget_btn btn btn-success">UPDATE LESSON</button>
                        </div>
                    </form>
                </div>
            </div>
